(function () {
  ...
  const translations = {
    pt: {
      ...
      'global.nav.contact_short': 'Contato',
      ...
      'index.about.text': 'Promovemos <strong>inovação operacional</strong> por meio de <strong>serviços de apoio administrativo</strong> focado em atender PMEs que visam melhorar suas entregas e executar tarefas de forma mais otimizada, explorando a máxima <strong>eficiência</strong> e <strong>produtividade</strong>. Para isso, utilizamos todo nosso <i>know-how</i> e experiência para desenvolver <strong>soluções <i>low-cost</i></strong> para o cliente obter sua melhor performance e competitividade.',
      ...
      'index.team.title': 'Nosso<span> time!</span>',
      'index.team.member1.alt': 'Foto de Filipe Oliveira',
      'index.team.member1.role': 'Gestão de Operações<br><span id="founder"><i class="bi bi-star-fill"></i> Founder</span>',
      'index.team.member2.alt': 'Foto de Flávio Oliveira',
      'index.team.member2.role': 'Engenharia de Produção<br><span class="partner"><i class="bi bi-star-fill"></i> Parceiro <br>Analista Comercial na<br><b>Nexa Resources</b></span>',
      ...
      'index.contact.title': '<strong>Se interessou?</strong><br id="fale">Preencha o formulário e <span>TESTE GRÁTIS!</span>',
      'index.contact.desc': 'Estamos disponíveis de <strong>segunda</strong> à <strong>sexta</strong>, das <strong>9h</strong> às <strong>18h</strong>. Ao lado, <strong>preencha o formulário</strong> que em menos de 24 horas entramos em contato com você.',
    ...
    en: {
      ...
      'global.nav.contact_short': 'Contact',
      ...
      'index.about.title': 'Who <span>we are?</span>',
      'index.about.text': 'We drive <strong>operational innovation</strong> through <strong>administrative support services</strong> focused on SMEs that want to improve their deliveries and execute tasks in a more optimized way, maximizing <strong>efficiency</strong> and <strong>productivity</strong>. To do that, we use all our <i>know-how</i> and experience to develop <strong><i>low-cost</i> solutions</strong> so the client achieves their best performance and competitiveness.',
      ...
      'index.team.title': 'Our<span> team!</span>',
      'index.team.member1.alt': 'Photo of Filipe Oliveira',
      'index.team.member1.role': 'Operations Management<br><span id="founder"><i class="bi bi-star-fill"></i> Founder</span>',
      'index.team.member2.alt': 'Photo of Flávio Oliveira',
      'index.team.member2.role': 'Production Engineering<br><span class="partner"><i class="bi bi-star-fill"></i> Partner <br>Sales Analyst at<br><b>Nexa Resources</b></span>',
      ...
      'index.contact.title': '<strong>Interested?</strong><br id="fale">Fill out the form and <span>TRY IT FOR FREE!</span>',
      ...
      'learn1.title': 'F91 - Soluções Operacionais | A More Efficient and Productive Business!',
    ...
    es: {
      ...
      'global.nav.contact': 'Contáctanos',
      'global.nav.contact_short': 'Contacto',
      ...
      'index.about.text': 'Impulsamos la <strong>innovación operativa</strong> mediante <strong>servicios de apoyo administrativo</strong> enfocados en pymes que buscan mejorar sus entregas y ejecutar tareas de forma más optimizada, maximizando la <strong>eficiencia</strong> y la <strong>productividad</strong>. Para ello, utilizamos todo nuestro <i>know-how</i> y experiencia para desarrollar <strong>soluciones <i>low-cost</i></strong> para que el cliente obtenga su mejor desempeño y competitividad.',
      ...
      'index.team.title': 'Nuestro<span> equipo!</span>',
      'index.team.member1.alt': 'Foto de Filipe Oliveira',
      'index.team.member1.role': 'Gestión de Operaciones<br><span id="founder"><i class="bi bi-star-fill"></i> Fundador</span>',
      'index.team.member2.alt': 'Foto de Flávio Oliveira',
      'index.team.member2.role': 'Ingeniería de Producción<br><span class="partner"><i class="bi bi-star-fill"></i> Socio <br>Analista Comercial en<br><b>Nexa Resources</b></span>',
      ...
      'index.contact.title': '<strong>¿Te interesó?</strong><br id="fale">Completa el formulario y <span>¡PRUÉBALO GRATIS!</span>',
      ...
      'learn1.title': 'F91 - Soluções Operacionais | ¡Un negocio más eficiente y productivo!',
