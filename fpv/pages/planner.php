        ...
        <header class="glass-header sticky top-0 z-40 border-b border-gray-200 shadow-sm no-print">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <button id="exportButton" class="text-sm text-f91-navy hover:text-f91-limeDark transition-colors flex items-center gap-1 font-medium bg-gray-100 hover:bg-gray-200 px-3 py-1.5 rounded-lg">
            ...
            <div class="xl:col-span-4 space-y-6">
                ...
                <div class="bg-f91-card rounded-2xl p-6 shadow-sm border border-gray-100">
                    ...
                    <form id="planning-form" class="space-y-4">
                        <div>
                            <label class="block text-sm font-medium text-f91-navy mb-1">Valor em caixa (R$)</label>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    <span class="text-f91-muted sm:text-sm">R$</span>
                                </div>
                                <input type="number" id="input-saved" step="0.01" min="0" class="block w-full pl-10 pr-3 py-2 border border-gray-200 rounded-xl focus:ring-f91-lime focus:border-f91-lime sm:text-sm transition-all outline-none bg-gray-50 focus:bg-white" placeholder="0.00">
                            </div>
                        </div>

                        <div>
                            <label class="block text-sm font-medium text-f91-navy mb-1">Data Meta</label>
                            <input type="date" id="input-date" class="block w-full px-3 py-2 border border-gray-200 rounded-xl focus:ring-f91-lime focus:border-f91-lime sm:text-sm transition-all outline-none bg-gray-50 focus:bg-white text-f91-text">
                        </div>
                    </form>
                ...
                <div class="bg-f91-card rounded-2xl p-6 shadow-sm border border-gray-100">
                    <div class="flex justify-between items-center mb-3">
                        ...
                        <button onclick="openModal('category-modal')" class="text-xs text-f91-navy hover:text-f91-limeDark font-medium px-2 py-1 bg-gray-100 rounded-md transition-colors">
                            + Nova
                        </button>
                    </div>
            ...
            <div class="xl:col-span-8 bg-f91-card rounded-2xl shadow-sm border border-gray-100 flex flex-col h-[calc(100vh-8rem)] xl:h-auto">
                    ...
                    <form id="add-item-form" class="space-y-4">
                        <div class="flex flex-col md:flex-row gap-3 items-end">
                            ...
                            <div class="flex-grow w-full">
                                <input type="text" id="item-name" required class="block w-full px-3 py-2 border border-gray-200 rounded-xl focus:ring-f91-lime focus:border-f91-lime sm:text-sm outline-none bg-gray-50 focus:bg-white transition-all" placeholder="Nome do Equipamento (Ex: Nazgul5 V3)">
                            </div>
                        ...
                        <div class="flex flex-col md:flex-row gap-3 items-end">
                            <div class="flex-grow w-full relative">
                                ...
                                <input type="url" id="item-url" class="block w-full pl-9 pr-3 py-2 border border-gray-200 rounded-xl focus:ring-f91-lime focus:border-f91-lime sm:text-sm outline-none bg-gray-50 focus:bg-white transition-all" placeholder="Link da loja (opcional)">
                            </div>
                            ...
                            <div class="w-full md:w-32 relative">
                                ...
                                <input type="number" id="item-price" required step="0.01" min="0" class="block w-full pl-8 pr-3 py-2 border border-gray-200 rounded-xl focus:ring-f91-lime focus:border-f91-lime sm:text-sm outline-none bg-gray-50 focus:bg-white transition-all" placeholder="0.00">
                            </div>
                ...
                <div class="flex-grow overflow-y-auto p-4 sm:p-6 bg-gray-50 rounded-b-2xl">
                    ...
                    <div id="empty-state" class="hidden flex-col items-center justify-center py-12 text-center h-full">
                        ...
                        <h3 class="text-lg font-medium text-f91-navy mb-1">Nenhum equipamento adicionado</h3>
    ...
    <div id="category-modal" class="fixed inset-0 z-50 flex items-center justify-center modal-enter p-4 no-print">
        ...
        <div class="bg-white rounded-2xl shadow-xl w-full max-w-md relative z-10 modal-scale-enter overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-100 flex justify-between items-center bg-gray-50">
                <h3 class="text-lg font-semibold text-f91-navy">Nova Categoria</h3>
            ...
            <form id="add-category-form" class="p-6 space-y-4">
                <div>
                    <label class="block text-sm font-medium text-f91-navy mb-1">Nome da Categoria</label>
                    <input type="text" id="cat-name" required class="block w-full px-3 py-2 border border-gray-200 rounded-xl focus:ring-f91-lime outline-none bg-gray-50 focus:bg-white" placeholder="Ex: Câmeras HD">
                </div>
                <div>
                    <label class="block text-sm font-medium text-f91-navy mb-1">Cor</label>
                ...
                <div class="flex justify-end gap-2 pt-2">
                    <button type="button" onclick="closeModal('category-modal')" class="px-4 py-2 text-sm text-f91-navy hover:bg-gray-100 rounded-lg transition-colors">Cancelar</button>
    ...
    <div id="export-modal" class="fixed inset-0 z-50 flex items-center justify-center modal-enter p-4 no-print">
        ...
        <div class="bg-white rounded-2xl shadow-xl w-full max-w-lg relative z-10 modal-scale-enter overflow-hidden max-h-[85vh] flex flex-col">
            <div class="px-6 py-4 border-b border-gray-100 flex justify-between items-center bg-gray-50 no-print">
                <h3 class="text-lg font-semibold text-f91-navy">Lista de Compras</h3>
            ...
            <div class="overflow-y-auto p-6" id="print-area">
                ...
                <div class="flex justify-between font-bold text-f91-navy border-t-2 border-gray-200 mt-2 pt-3">
            ...
            <div class="px-6 py-4 border-t border-gray-100 flex justify-end gap-2 no-print">
                <button onclick="closeModal('export-modal')" class="px-4 py-2 text-sm text-f91-navy hover:bg-gray-100 rounded-lg transition-colors">Fechar</button>
